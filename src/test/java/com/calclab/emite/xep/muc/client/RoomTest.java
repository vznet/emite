...
public class RoomTest extends AbstractChatTest {
    ...
    public void shouldAddOccupantAndFireListeners() {
        ...
        final Occupant occupant = room.setOccupantPresence(userURI, occupantUri, "aff", "role", Show.unknown, null, null, null);
    ...
    public void shouldRemoveOccupant() {
        ...
        room.setOccupantPresence(userURI, occupantUri, "owner", "participant", Show.notSpecified, null, null, null);
    ...
    public void shouldUpdateOccupantAndFireListeners() {
        ...
        room.addOccupantChangedHandler(handler);
        final XmppURI occupantUri = uri("room@domain/name");
        final Occupant occupant = room.setOccupantPresence(userURI, occupantUri, "owner", "participant", Show.notSpecified, null, null, null);
        final Occupant occupant2 = room.setOccupantPresence(userURI, occupantUri, "admin", "moderator", Show.notSpecified, null, null, null);
        assertEquals(1, handler.getCalledTimes());
